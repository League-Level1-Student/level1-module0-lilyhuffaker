	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if(guess.equals("Arnold")) {
				JOptionPane.showMessageDialog(null, "Wow, you did the gucci gang.");
				score++;
			}
			else {
				JOptionPane.showMessageDialog(null, "No you Poopy butt, I am the dissapoint.");
			}
			// 6. Otherwise:
			...
			String guessdos= JOptionPane.showInputDialog("Who is this boyo?");
			if (guessdos.equals("Leoardo")) {
				JOptionPane.showMessageDialog(null, "yEETUS THAT FEETUS, GOOD JOB MY DUDE");
				score++;
		}
			else {
				JOptionPane.showMessageDialog(null, "Oof thats wrong.");
			}
			JOptionPane.showMessageDialog(null, "uR SCORE IS: "+score);
				//ur working on this boyo /\/\/\//\/\///\/\
		}
